...
if( isset( $_REQUEST["action"] ) )
{
	...
	{
		fix_emails();
        set_alert("SUCCESS", "Subscriptions have been fixed.");
	}
	else if( $action == "Clear Subscriptions" )
	{
		clear_subscriptions();
        set_alert("SUCCESS", "Subscriptions have been cleared.");
	}
}
...
<h2>Subscription Helpers</h2>

<h3>Mass Mailing List Operations</h3>
...
<form method="post" action="">
    <input class="btn btn-default" type="submit" name="action" value="Fix Subscriptions"/>
</form>
</div>
...
<form method="post" action="">
    <input class="btn btn-default" type="submit" name="action" value="Clear Subscriptions"/>
</form>
</div>
