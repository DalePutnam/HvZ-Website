...
/* direct access -> \/ */					 $anti_hammer_version = '0.9.3.2';

// Removed this so I can use this file differently
...
/*
	...
	Anti-Hammer won't work.
													...
													*/
$anti_hammer['info_path'] = $_SERVER['DOCUMENT_ROOT'].'hvz/anti-hammer/sessions';
...
/*
	...
	Specify four integer values, separated by commas, whole thing in quotes.
																*/
$anti_hammer['trigger_levels'] = '20,40,60,80';
...
/*
	...
	[default: $anti_hammer['cut_off'] = 50]
	...
	Leave blank to disable the cut-off. e.g.. $anti_hammer['cut_off'] = '';
							*/
$anti_hammer['cut_off'] = 50;
...
/*
	...
	Very handy for busy webmasters.
																	*/
$anti_hammer['admin_agent_string'] = 'YouCantGuessMe';
...
if ($anti_hammer['cut_off'] and isset($session['cut_off'])) {
...
if ($killpage) {
	...
	if (!isset($session['cut_off'])) {
		...
		id="link-Get-Anti-Hammer" href="http://corz.org/server/tools/anti-hammer/">Get Anti-Hammer protection for your own site!</a></span></body></html>';
	}
	kill_page($km);
}
